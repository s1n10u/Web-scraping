...
item_price = item_name2 = item_name1 = item_name = item_list = item_list1 = item = mrp =items= name = []
...
Webpath = 'C:/Users/suresh/chromedriver'
...
def jiomart():
    ...
    browser = webdriver.Chrome(Webpath, options=options)
