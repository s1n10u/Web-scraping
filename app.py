...
def scraping():
    ...
    data.to_csv('C:/Users/suresh/users/gharwaalaa/jiostore.csv')
    data=data
...
def winniscrap():
    ...
    data = pd.DataFrame(item_list)
    data.to_csv('C:/Users/suresh/users/gharwaalaa/winnistore_data.csv')
    data=data
...
def manakr():
    ...
    data = pd.DataFrame(item_list)
    data.to_csv('C:/Users/suresh/users/gharwaalaa/manakiranam_data.csv')
    data=data
...
def main():
    ...
    if option == 0:
        ...
        if st.button("DATA_DOWNLOAD"):
            df = pd.read_csv("C:/Users/suresh/users/gharwaalaa/jiostore.csv")
            df = df.drop_duplicates(subset=['name', 'price', 'MRP'], keep="first")
            df = df.loc[:, ~df.columns.str.contains('^Unnamed')]

            df.to_csv('C:/Users/suresh/users/gharwaalaa/jiostore.csv')
            csv_downloader(df)
            st.balloons()
        ...
        if st.button("DOWNLOAD"):
            df = pd.read_csv("C:/Users/suresh/users/gharwaalaa/winnistore_data.csv")
            df = df.drop_duplicates(subset=['name', 'price', 'MRP'], keep="first")
            df = df.loc[:, ~df.columns.str.contains('^Unnamed')]

            df.to_csv('C:/Users/suresh/users/gharwaalaa/winnistore_data.csv')
            csv_downloader(df)
            st.balloons()
        ...
        if st.button("DOWNLOAD_FILE"):
            df = pd.read_csv("C:/Users/suresh/users/gharwaalaa/manakiranam_data.csv")
            df = df.drop_duplicates(subset=['name', 'price', 'MRP'], keep="first")
            df = df.loc[:, ~df.columns.str.contains('^Unnamed')]

            df.to_csv('C:/Users/suresh/users/gharwaalaa/manakiranam_data.csv')
            csv_downloader(df)
            st.balloons()
